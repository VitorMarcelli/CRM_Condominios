    ...
    <div className="space-y-8 pb-12 w-full max-w-[800px] mx-auto font-sans">
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white">Novo Condomínio</h1>
            <p className="text-sm font-semibold text-slate-500 dark:text-slate-400 mt-1">Preencha os dados para registrar um novo cliente.</p>
          </div>
        </div>
      </div>
